...
grammer = { 'r2': [ 'E','E+T', "values[-3]+' '+values[-1]+' +'" ], 'r3': [ 'E','T', "values[-1]" ], 'r4': [ 'T','T*F', "values[-3]+' '+values[-1]+' *'" ], 
        'r5': [ 'T','F', "values[-1]" ], 'r6': [ 'F','(E)', "values[-2]" ], 'r7': ['F','Fd', " values[-2]+values[-1]"], 'r8': ['F','d', "values[-1]"] }
...
Parse_table = [
	...
	[ ['r5'],	['r5'],	['e'],	['r5'],	['cnf1'],['r5'],		['e'],	['e'],	['e']  	],
	[ ['e'],	['e'],	['e'],	['e'],	['e'],	['s5'],		[11],	[2],	[3]  	],
	[ ['r8'],	['r8'],	['e'],	['r8'],	['r8'],	['cnf2'],		['e'],	['e'],	['e']  	],
	[ ['e'],	['e'],	['e'],	['e'],	['e'],	['acc'],	['e'],	['e'],	['e']  	],
	[ ['e'],	['e'],	['s4'],	['e'],	['s5'],	['e'],		['e'],	[8],	[3]  	],
...
while True:
    ...
    if move == 'cnf1':                                   # removing conflict by deciding action in confliciting situtation
